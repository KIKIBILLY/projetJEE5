        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="${admin.urlPhoto}" alt="User profile picture">

              <h3 class="profile-username text-center">${admin.nom} ${admin.prenom} </h3>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">${admin.adresseHabitation}</p>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="settings">
                <form class="form-horizontal" action="ProfileAdmin" method="post">
